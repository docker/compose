...
func (lk *LogKeyboard) openDockerDesktop(ctx context.Context, project *types.Project) {
	...
	go func() {
		tracing.EventWrapFuncForErrGroup(ctx, "menu/gui", tracing.SpanOptions{},
...
func (lk *LogKeyboard) openDDComposeUI(ctx context.Context, project *types.Project) {
	...
	go func() {
		tracing.EventWrapFuncForErrGroup(ctx, "menu/gui/composeview", tracing.SpanOptions{},
			func(ctx context.Context) error {
...
func (lk *LogKeyboard) openDDWatchDocs(ctx context.Context, project *types.Project) {
	go func() {
		tracing.EventWrapFuncForErrGroup(ctx, "menu/gui/watch", tracing.SpanOptions{},
			func(ctx context.Context) error {
...
func (lk *LogKeyboard) ToggleWatch(ctx context.Context, options api.UpOptions) {
	...
	if lk.Watch.Watching {
		...
		go func() {
			tracing.EventWrapFuncForErrGroup(ctx, "menu/watch", tracing.SpanOptions{},
				func(ctx context.Context) error {
