...
func waitCommand(p *ProjectOptions, dockerCli command.Cli, backendOptions []compose.Option) *cobra.Command {
	opts := waitOptions{
		ProjectOptions: p,
	}
...
func runWait(ctx context.Context, dockerCli command.Cli, backendOptions []compose.Option, opts *waitOptions) (int64, error) {
