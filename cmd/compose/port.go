...
func portCommand(p *ProjectOptions, dockerCli command.Cli, backendOptions []compose.Option) *cobra.Command {
	opts := portOptions{
		ProjectOptions: p,
	}
	cmd := &cobra.Command{
...
func runPort(ctx context.Context, dockerCli command.Cli, backendOptions []compose.Option, opts portOptions, service string) error {
