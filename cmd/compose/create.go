...
func createCommand(p *ProjectOptions, dockerCli command.Cli, backendOptions []compose.Option) *cobra.Command {
	opts := createOptions{}
...
func runCreate(ctx context.Context, dockerCli command.Cli, backendOptions []compose.Option, createOpts createOptions, buildOpts buildOptions, project *types.Project, services []string) error {
