...
func pushCommand(p *ProjectOptions, dockerCli command.Cli, backendOptions []compose.Option) *cobra.Command {
	opts := pushOptions{
		ProjectOptions: p,
	}
...
func runPush(ctx context.Context, dockerCli command.Cli, backendOptions []compose.Option, opts pushOptions, services []string) error {
