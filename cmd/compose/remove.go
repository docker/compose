...
func removeCommand(p *ProjectOptions, dockerCli command.Cli, backendOptions []compose.Option) *cobra.Command {
	opts := removeOptions{
		ProjectOptions: p,
	}
	cmd := &cobra.Command{
...
func runRemove(ctx context.Context, dockerCli command.Cli, backendOptions []compose.Option, opts removeOptions, services []string) error {
