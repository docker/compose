...
ENV ALL_DOCKER_VERSIONS 1.7.1 1.8.0-rc2
...
RUN set -ex; \
    ...
    curl https://test.docker.com/builds/Linux/x86_64/docker-1.8.0-rc2 -o /usr/local/bin/docker-1.8.0-rc2; \
    chmod +x /usr/local/bin/docker-1.8.0-rc2
