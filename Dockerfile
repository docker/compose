...
ENV ALL_DOCKER_VERSIONS 1.6.0 1.7.1-rc3
...
RUN set -ex; \
    ...
    curl https://test.docker.com/builds/Linux/x86_64/docker-1.7.1-rc3 -o /usr/local/bin/docker-1.7.1-rc3; \
    chmod +x /usr/local/bin/docker-1.7.1-rc3
