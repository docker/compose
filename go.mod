...
require (
	...
	github.com/docker/cli v27.0.0-rc.2.0.20240618151400-64206aef767d+incompatible
	github.com/docker/cli-docs-tool v0.7.0
	github.com/docker/docker v27.0.0-rc.2.0.20240620082716-a24af26aba4a+incompatible // v27.0.0-rc.2
