...
// https://github.com/docker/buildx/blob/v0.7.1/go.mod#L58-L65
replace (
...
replace github.com/docker/docker-credential-helpers => github.com/docker/docker-credential-helpers v0.6.4-0.20210125172408-38bea2ce277a
