...
require (
	...
	github.com/docker/cli v25.0.0-rc.2.0.20240117132858-d161a2a47097+incompatible
	github.com/docker/cli-docs-tool v0.6.0
	github.com/docker/docker v25.0.0-rc.2.0.20240117163151-436bf27e6cfe+incompatible
