...
which the release page specifies, in your terminal.
     ...
     The following is an example command illustrating the format:
        ...
        curl -L https://github.com/docker/compose/releases/download/1.6.0rc3/docker-compose-`uname -s`-`uname -m` > /usr/local/bin/docker-compose
...
7. Test the installation.
        ...
        docker-compose version: 1.6.0rc3
...
To install compose as a container run:
    ...
    $ curl -L https://github.com/docker/compose/releases/download/1.6.0rc3/run.sh > /usr/local/bin/docker-compose
    $ chmod +x /usr/local/bin/docker-compose
